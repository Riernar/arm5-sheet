...
const k = (function(){
  ...
  const cascades = {"attr_character_name":{"name":"character_name","type":"text","defaultValue":"","affects":[],"triggeredFuncs":["setActionCalls"],"listenerFunc":"accessSheet","listener":"change:character_name"},"attr_arm5_sheet_alerts_states":{"name":"arm5_sheet_alerts_states","type":"hidden","defaultValue":"{}","triggeredFuncs":[],"affects":[]},"attr_notNew":{"name":"notNew","type":"number","affects":[],"triggeredFuncs":[]},"attr_repeating_weapons_$X_Wounds_Load":{"name":"repeating_weapons_$X_Wounds_Load","type":"number","affects":[],"triggeredFuncs":[]},"attr_repeating_weapons_$X_Wounds_Range":{"name":"repeating_weapons_$X_Wounds_Range","type":"string","affects":[],"triggeredFuncs":[]},"attr_repeating_weapons_$X_Weapon_Load":{"name":"repeating_weapons_$X_Weapon_Load","type":"number","affects":[],"triggeredFuncs":[]},"attr_repeating_weapons_$X_Weapon_Range":{"name":"repeating_weapons_$X_Weapon_Range","type":"string","affects":[],"triggeredFuncs":[]},"attr_repeating_spell_$X_Technique_select":{"name":"repeating_spell_$X_Technique_select","type":"number","affects":[],"triggeredFuncs":[]},"attr_repeating_spell_$X_Form_select":{"name":"repeating_spell_$X_Form_select","type":"number","affects":[],"triggeredFuncs":[]},"attr_repeating_spell_$X_spell_tech_name":{"name":"repeating_spell_$X_spell_tech_name","type":"string","affects":[],"triggeredFuncs":[]},"attr_repeating_spell_$X_spell_form_name":{"name":"repeating_spell_$X_spell_form_name","type":"string","affects":[],"triggeredFuncs":[]},"act_alert-close-test-info":{"triggeredFuncs":["helpers.alerter.close"],"name":"alert-close-test-info","listener":"clicked:alert-close-test-info","listenerFunc":"accessSheet","type":"action"},"act_alert-close-test-warning":{"triggeredFuncs":["helpers.alerter.close"],"name":"alert-close-test-warning","listener":"clicked:alert-close-test-warning","listenerFunc":"accessSheet","type":"action"}};
  
  kFuncs.cascades = cascades;
  
  const repeatingSectionDetails = [{"section":"repeating_weapons","fields":["Wounds_Load","Wounds_Range","Weapon_Load","Weapon_Range"]},{"section":"repeating_spell","fields":["Technique_select","Form_select","spell_tech_name","spell_form_name"]}];
...
k.registerFuncs({ "helpers.alerter.onOpen": arm5.sheet.alerts.onOpen }, { type: ["opener"] }); 
   k.version = "2.0"; 
   helpers.updater.registerUpdatersToKScaffold({


});
  // Data that was created during sheet building and persisted
helpers.alerter.alerts = [
  "test-info",
  "test-warning"
];
  // Data that was created during sheet building and persisted
helpers.alerter.attributeName = "arm5_sheet_alerts_states";
